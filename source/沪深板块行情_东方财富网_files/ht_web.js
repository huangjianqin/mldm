(function(){
  ...
  var u = (_param.match(/u=(.+?)($|\||&)/i) != null) ? _param.match(/u=(.+?)($|\||&)/i)[1] : _url;//当前页面(模板)地址，非必填（默认为当前url），如果可变参数不为空，该地址变化区域请用{0}表示，目前仅支持{0}一种。
			...
			map.add("http://quote.eastmoney.com/center/fund.html", "http://wap.eastmoney.com/quoteCenter/center/default.aspx");
			map.add("http://quote.eastmoney.com/center/paihang.html", "http://wap.eastmoney.com/quoteCenter/center/List.aspx#0/1/0/C/-1");
	map.ByCheck(u,c);
})(window);